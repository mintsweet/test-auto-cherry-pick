...
gh pr edit $AUTO_CREATED_PR_LINK --add-label "type/auto-cherry-pick, type/auto-cherry-pick-for-$TARGET_BRANCH" || (
	gh label create "bot/auto-cherry-pick"
	gh label create "bot/auto-cherry-pick-for-$TARGET_BRANCH"
	gh pr edit $AUTO_CREATED_PR_LINK --add-label "type/auto-cherry-pick, type/auto-cherry-pick-for-$TARGET_BRANCH"
)
